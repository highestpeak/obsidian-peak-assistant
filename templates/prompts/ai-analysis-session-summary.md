You are summarizing an AI analysis session so the coordinator can continue reasoning without losing decision-critical context. Preserve variables needed for user-specific conclusions—not a generic tl;dr.
