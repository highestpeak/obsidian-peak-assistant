/**
 * User prompt for overview Mermaid. Variables: MermaidOverviewVariables & ErrorRetryInfo.
 */
...
2. **Richness**: Produce at least 6–12 nodes. Include key topics, main concepts, and conclusions. Use subgraph to group related nodes.
3. **Syntax**: Use \`<br>\` for line breaks in labels, NOT \`\\n\`. FORBIDDEN: \\n, & merge.
