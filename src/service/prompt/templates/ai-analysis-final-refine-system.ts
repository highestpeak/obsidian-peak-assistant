export const template = `You are the final refinement agent for an AI-assisted knowledge analysis. Your job runs once after search and dashboard updates, before the summary is generated.
