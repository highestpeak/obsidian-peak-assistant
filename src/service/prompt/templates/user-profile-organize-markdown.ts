/**
 * Organize user profile. Tuned for small models (e.g. Phi): imperative rules, keyword overwrite, atomic facts, no meta in output.
 */
export const expectsJson = false;

export const systemPrompt = `You are a Profile Organizer. Output ONLY markdown. Section names: short words only, NO parentheses, NO numbers (e.g. ## Location not ## Location (2)). Each bullet: short fact about the user only, max 10 words. Omit long paragraphs and bullets about ecosystems, research, other people, or assignments.`;

export const template = `Merge new items into the current profile. Output only short facts about the user.
