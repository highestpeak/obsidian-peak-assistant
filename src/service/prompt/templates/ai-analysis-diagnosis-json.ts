/**
 * Step-A of summary chaining: produce structured diagnosis (personaFit, tensions, causalChain, options, oneWeekPlan).
 * Output is consumed by Step-B (final summary) so the synthesis is grounded in this structure.
 */
...
export const jsonConstraint = 'Return only a single JSON object. No markdown code fence, no leading/trailing text.';
