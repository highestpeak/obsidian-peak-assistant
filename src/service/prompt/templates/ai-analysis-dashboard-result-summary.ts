/**
 * User prompt for synthesis summary. Variables: AiSummaryVariables & { retrievedSessionContext? }.
 * Use call_search_agent when you need to look up content from the vault.
 */
