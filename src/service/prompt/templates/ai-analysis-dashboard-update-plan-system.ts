 ...
 * Outputs topicsPlan, blockPlan. No graph references.
 */
export const template = `You are the "Architect of Dashboard Evolution". Your job is to produce a **dashboard update plan**: precise, grounded instructions that route work to topics and blocks.
