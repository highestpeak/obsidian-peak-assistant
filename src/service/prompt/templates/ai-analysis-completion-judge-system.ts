export const template = `You are the Completion Judge. Your role is to decide whether the AI search analysis has reached sufficient completeness to stop.
...
export const jsonConstraint = 'Return only a JSON object with shouldStop, why, confidence, missingItems.';
