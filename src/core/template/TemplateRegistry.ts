...
export const TEMPLATE_METADATA: Record<TemplateId, TemplateMetadata> = {
	...
	'sources-update-agent-system': meta('prompts', 'sources-update-agent-system'),
	'topics-update-agent-system': meta('prompts', 'topics-update-agent-system'),
	'graph-update-agent-system': meta('prompts', 'graph-update-agent-system'),
	...
	'memory-update-bullet-list': meta('prompts', 'memory-update-bullet-list'),
	'user-profile-update-json': meta('prompts', 'user-profile-update-json', { expectsJson: true, jsonConstraint: 'Return only the JSON object, nothing else.' }),
	'instruction-update': meta('prompts', 'instruction-update'),
	...
	'ai-analysis-diagnosis-json': meta('prompts', 'ai-analysis-diagnosis-json', { expectsJson: true, jsonConstraint: 'Return only a single JSON object. No markdown code fence, no leading/trailing text.' }),
	...
	'ai-analysis-dashboard-update-sources-system': meta('prompts', 'ai-analysis-dashboard-update-sources-system'),
	'ai-analysis-dashboard-update-sources': meta('prompts', 'ai-analysis-dashboard-update-sources', { systemPromptId: 'ai-analysis-dashboard-update-sources-system' as PromptId }),
	...
	'ai-analysis-dashboard-update-graph-system': meta('prompts', 'ai-analysis-dashboard-update-graph-system'),
	'ai-analysis-dashboard-update-graph': meta('prompts', 'ai-analysis-dashboard-update-graph', { systemPromptId: 'ai-analysis-dashboard-update-graph-system' as PromptId }),
	...
	'ai-analysis-completion-judge-system': meta('prompts', 'ai-analysis-completion-judge-system', { expectsJson: true, jsonConstraint: 'Return only a JSON object with shouldStop, why, confidence, missingItems.' }),
	'ai-analysis-completion-judge': meta('prompts', 'ai-analysis-completion-judge', { expectsJson: true, jsonConstraint: 'Return only a JSON object with shouldStop, why, confidence, missingItems.', systemPromptId: 'ai-analysis-completion-judge-system' as PromptId }),
	...
	'ai-analysis-final-refine-graph-system': meta('prompts', 'ai-analysis-final-refine-graph-system'),
	'ai-analysis-final-refine-graph': meta('prompts', 'ai-analysis-final-refine-graph', { systemPromptId: 'ai-analysis-final-refine-graph-system' as PromptId }),
