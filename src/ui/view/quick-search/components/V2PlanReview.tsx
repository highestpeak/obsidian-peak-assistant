...
import { ChevronUp, ChevronDown, Trash2, Sparkles, FileText, AlertTriangle } from 'lucide-react';
	...
	return (
		<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="pktw-flex pktw-flex-col pktw-h-full pktw-overflow-hidden">
			...
			<div className="pktw-mb-4">
				<div className="pktw-flex pktw-items-center pktw-gap-2 pktw-px-1 pktw-mb-3">
				...
				{/* Executive Summary — always present, auto-generated */}
				...
				{/* Uncovered optional roles — subtle hint */}
			...
			{/* Sticky footer: insights + generate button */}
