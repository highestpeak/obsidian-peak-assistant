...
export const SaveDialog: React.FC<ResultSaveDialogProps> = ({ onClose }) => {
	...
	return (
		<div className="pktw-fixed pktw-inset-0 pktw-bg-black/40 pktw-flex pktw-items-center pktw-justify-center pktw-z-50 pktw-p-4">
			<div className="pktw-bg-popover pktw-rounded-lg pktw-shadow-2xl pktw-border pktw-border-border pktw-w-full pktw-max-w-lg">
				{/* Header */}
