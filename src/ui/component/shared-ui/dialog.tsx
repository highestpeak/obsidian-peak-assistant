...
>(({ className, ...props }, ref) => (
	<DialogPrimitive.Overlay
		ref={ref}
		className={cn(
			'pktw-fixed pktw-inset-0 pktw-z-50 pktw-bg-black/40 data-[state=open]:pktw-animate-in data-[state=closed]:pktw-animate-out data-[state=closed]:pktw-fade-out-0 data-[state=open]:pktw-fade-in-0',
			className
		)}
		{...props}
	/>
