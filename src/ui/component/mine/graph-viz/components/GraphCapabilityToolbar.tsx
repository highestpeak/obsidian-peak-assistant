		...
		<>
			{hops ? (
				<div className="pktw-flex-shrink-0 pktw-flex pktw-items-center pktw-gap-2 pktw-py-1.5">
					<span className="pktw-text-[11px] pktw-font-medium pktw-text-pk-foreground-muted pktw-flex pktw-items-center pktw-gap-1.5">
			...
			{findPath ? (
				<>
					<div className="pktw-flex-shrink-0 pktw-flex pktw-items-center pktw-gap-2 pktw-py-1.5 pktw-border-t pktw-border-pk-border">
						<span className="pktw-text-[11px] pktw-font-medium pktw-text-pk-foreground-muted pktw-flex pktw-items-center pktw-gap-1">
							<Route className="pktw-w-3.5 pktw-h-3.5" />
							Find path
						</span>
						<input
							type="text"
							className="pktw-h-6 pktw-flex-1 pktw-min-w-0 pktw-max-w-[240px] pktw-text-xs pktw-rounded-lg pktw-border pktw-border-pk-border pktw-bg-white pktw-px-2 pktw-truncate pktw-shadow-none focus:pktw-outline-none focus:pktw-ring-0"
					...
					{(pathResult || pathError) ? (
						<div className="pktw-flex-shrink-0 pktw-border-t pktw-border-pk-border pktw-max-h-[120px] pktw-overflow-y-auto pktw-py-1.5">
							{pathError ? (
							...
							{pathResult ? (
								<>
									{pathStart && selectedPathTarget ? (
										<div className="pktw-text-[11px] pktw-text-pk-foreground-muted pktw-mb-1">
